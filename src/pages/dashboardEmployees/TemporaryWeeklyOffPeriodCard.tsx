  ...
  return (
    <div className="dsv2-stack dsv2-stack--sm" data-weekly-off-management="true">
      ...
      <WorkspaceNoticeV2
        ...
        description={
          baseOffDay
            ? `الإجازة الأسبوعية الأساسية هي ${baseOffDay.label} وتبقى محفوظة. استخدم «تغيير يوم الإجازة مؤقتًا» لنقلها إلى يوم آخر لفترة، أو «إيقاف الإجازة مؤقتًا» إذا كانت الموظفة ستعمل بدون إجازة أسبوعية خلال الفترة. بعد تاريخ النهاية يرجع ${baseOffDay.label} تلقائيًا، وتبقى الحضور والشفتات والرواتب مرتبطة بالجدول الفعلي لكل تاريخ.`
            : "حدد يوم إجازة أسبوعية أساسي واحد من الأيام أعلاه. بعد ذلك لا تحذفه عند أي تغيير مؤقت؛ استخدم الاستثناءات المحددة بتاريخ حتى يعود النظام تلقائيًا إلى الأساس بعد انتهائها."
        }
