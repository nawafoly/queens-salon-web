  ...
  return (
    <div className="dsv2-stack dsv2-stack--sm" data-weekly-off-management="true">
      <div className="dsv2-section-head">
        <div>
          ...
          <p className="dsv2-section-caption">
            اليوم الأساسي يبقى محفوظًا دائمًا. استخدم الاستثناء المؤقت فقط عندما تريد نقله أو إيقافه لفترة محددة.
          </p>
        </div>
        {baseOffDay ? (
      ...
      <WorkspaceNoticeV2
        ...
        description={
          baseOffDay
            ? `الإجازة الأسبوعية الأساسية هي ${baseOffDay.label} ولا تُحذف عند إنشاء استثناء. «تغيير يوم الإجازة مؤقتًا» ينقل الراحة إلى يوم آخر بين تاريخين. «إيقاف الإجازة مؤقتًا» يجعل ${baseOffDay.label} يوم عمل خلال الفترة بدون إنشاء يوم راحة بديل. في الحالتين، بعد تاريخ النهاية يرجع ${baseOffDay.label} إجازة أسبوعية تلقائيًا، ويستمر التقويم والحضور والرواتب على الجدول الفعلي لكل تاريخ.`
            : "حدد يوم إجازة أسبوعية أساسي واحد من الأيام أعلاه أولًا. بعد ذلك اتركه محفوظًا واستخدم الاستثناءات المؤقتة لأي تغيير محدد بزمن، بدل حذف الإجازة الأساسية وإعادتها يدويًا لاحقًا."
        }
