...
function coreIncomeToLegacy(row: import("../types/coreApi").CoreIncomeEntry): IncomeItem {
  ...
  return {
    ...
    bookingPublicId: row.bookingPublicId || undefined,
    bookingDate: row.bookingDate || undefined,
    bookingStatus: row.bookingStatus || undefined,
    bookingTotal: row.bookingTotalHalalas == null ? undefined : Number(row.bookingTotalHalalas) / 100,
    bookingPaid: row.bookingPaidHalalas == null ? undefined : Number(row.bookingPaidHalalas) / 100,
    bookingPaymentStatus: row.bookingPaymentStatus || undefined,
    bookingStaffId: row.bookingStaffId || undefined,
    bookingStaffName: row.bookingStaffName || undefined,
    bookingClientName: row.bookingClientName || undefined,
    bookingClientPhone: row.bookingClientPhone || undefined,
    bookingInvoiceId: row.bookingInvoiceId || undefined,
    bookingInvoiceNumber: row.bookingInvoiceNumber || undefined,
