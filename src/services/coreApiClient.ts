...
const CORE_API_CODE_MESSAGES: Record<string, string> = {
  ...
  "core_leave:not_found": "لا توجد إجازة معتمدة لهذه الموظفة في هذا اليوم.",
  "core_annual_leave:leave_not_found": "لا توجد إجازة سنوية معتمدة لهذا اليوم.",
  "core_weekly_rest_work:not_weekly_rest_day": "هذا اليوم ليس راحة أسبوعية في الجدول.",
  "core_weekly_rest_work:approved_leave_conflict": "لا يمكن تنفيذ العملية لوجود إجازة معتمدة في نفس اليوم.",
  "core_weekly_rest_work:assignment_not_found": "لا يوجد تكليف عمل على يوم الراحة لإلغائه.",
